...
import { ACCOUNTS_ROUTE, APP_ROUTE, BASE_ROUTE, DASHBOARD_ROUTE, DATA_SETTINGS_ROUTE, EXPENSE_CATEGORY_SETTINGS_ROUTE, INCOME_CATEGORY_SETTINGS_ROUTE, LOGIN_ROUTE, REGISTER_ROUTE, SETTINGS_ROUTE, TRANSACTIONS_ROUTE } from "./routes";
